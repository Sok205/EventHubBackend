...
urlpatterns = [
    ...
    path('api/users/', apiviews.UserList.as_view(), name='user-list'),
    path('api/users/<int:pk>/', apiviews.UserDetail.as_view(), name='user-detail'),
    path('api/users/me/', apiviews.UserProfileView.as_view(), name='user-profile'),
